...
async def test_run_logs_concise_lifecycle_summary(
    ...
    caplog.set_level(logging.INFO, logger="app.repositories.run_repository")
    ...
    messages = "\n".join(
        ...
        if record.name == "app.repositories.run_repository"
    )
...
async def test_failed_page_log_contains_debug_context(
    ...
    caplog.clear()
    caplog.set_level(logging.ERROR, logger="app.repositories.run_repository")
