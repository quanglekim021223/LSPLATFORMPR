...
from app.vendors.linkedin.course_catalog import (
    CATALOG_DOMAIN,
    DETAIL_DOMAIN,
    ingest_catalog_pipeline,
)
from app.vendors.linkedin.learning_history import DOMAIN as LEARNING_HISTORY
from app.vendors.linkedin.learning_history import ingest_learning_history
